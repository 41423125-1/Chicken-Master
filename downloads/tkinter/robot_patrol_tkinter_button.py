...
class World:
    ...
    def __init__(self, width, height):
        ...
        move_button = tk.Button(button_frame, text="前進 (J)", command=lambda: self.robot.move(1))
        move_button.pack(side=tk.LEFT, padx=5)
        
        turn_button = tk.Button(button_frame, text="左轉 (I)", command=lambda: self.robot.turn_left())
        turn_button.pack(side=tk.LEFT, padx=5)
